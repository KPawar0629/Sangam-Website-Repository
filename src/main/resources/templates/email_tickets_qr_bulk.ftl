...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
  <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); overflow: hidden;">
    ...
    <div style="padding: 30px;">
      ...
      <p style="font-size: 16px; color: #555555; line-height: 1.6;">Below are your ticket details. <strong>DO NOT share these ticket codes with anyone.</strong> They will be used to check you in at the registration desk on the event day.</p>
      
      <!-- QR Code for Ticket Master -->
      <div style="text-align: center; margin: 30px 0; padding: 25px; background-color: #f8f9fa; border-radius: 8px; border: 2px solid #dee2e6;">
        <h3 style="font-size: 18px; color: #333333; margin-top: 0; margin-bottom: 15px;">Your Check-In QR Code</h3>
        <img src="cid:qrcode_${ticket.ticketMasterId}" alt="Check-In QR Code" style="width: 200px; height: 200px; display: block; margin: 0 auto; border-radius: 8px;" />
        <p style="font-size: 14px; color: #6c757d; margin-top: 15px; margin-bottom: 0;">Present this QR code at the registration desk for quick check-in</p>
      </div>
