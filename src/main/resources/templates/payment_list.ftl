        ...
        <table class="table table-striped table-bordered" id="myTable">
            ...
            <#list ticketers as master>
                ...
                <#else>
                    ...
                    <td class="hide-on-md">${master.fullName}</th></td>
                    ...
                    <#if master.paymentReceivedBy?? && users[master.paymentReceivedBy]??>
                        ...
                        <td>
                        <a href="/tickets/undo/${master.ticketMasterId}" type="button" class="btn btn-warning" onclick="return confirm('Do you really want to undo this payment receipt?')" title="Undo Payment Receipt"><i class="fa-solid fa-rotate-left"></i></a></td>
                    <#else>
                        <td class="hide-on-md"></td>
                        <td class="hide-on-md"></td>
                        <td class="show-on-phone"><a class="btn btn-primary" onclick="return confirm('Phone Number: ${master.phoneNumber}')"> <p>${master.fullName}</p></a><p>${master.email}</p></td>
                        <td class="show-on-phone"># ${master.totalTickets}<br>$ ${master.totalAmount}</td>
                        <td class="hide-on-md">${master.phoneNumber}</td>
                        <td><a href="/tickets/delete/${master.ticketMasterId}" type="button" class="btn btn-danger" onclick="return confirm('Do you really want to delete this ticket?')" title="Delete Ticket"><i class="fa-solid fa-trash"></i></a></td>
                    </#if>
                </tr>
            </#list>
            </tbody>
