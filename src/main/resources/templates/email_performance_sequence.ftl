...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
  <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); overflow: hidden;">
    ...
    <div style="padding: 20px 30px; background-color: #4a5568; color: #ffffff; text-align: center;">
        <h1 style="margin: 0; font-size: 24px;">Performance Details</h1>
    </div>
    ...
    <div style="padding: 30px;">
      ...
      <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
        <tbody>
            <tr>
                <td style="border: 1px solid #dee2e6; padding: 12px; font-size: 16px; background-color: #f8f9fa; width: 40%;"><strong>Performance Order</strong></td>
                <td style="border: 1px solid #dee2e6; padding: 12px; font-size: 16px;">#${participant.orderNumber}</td>
            </tr>
            <tr>
                <td style="border: 1px solid #dee2e6; padding: 12px; font-size: 16px; background-color: #f8f9fa;"><strong>Participation Code</strong></td>
      ...
      <div style="font-size: 15px; color: #555555; line-height: 1.6; background-color: #fffbe6; border-left: 4px solid #ffc107; padding: 15px; margin: 20px 0;">
        <p style="margin:0 0 10px 0;">Please upload your song files ASAP if you haven't done so to avoid the cancellation of your performance.</p>
        <p style="margin:0 0 10px 0;">Rehearsals will be on Oct. 25, 2025 at ${event.eventLocation}.</p>
        <p style="margin:0 0 5px 0;">Performance order 1-10: 5-5:30pm.</p>
        <p style="margin:0 0 5px 0;">Performance order 11-20: 5:30-6pm.</p>
        <p style="margin:0 0 10px 0;">Performance order 21-30: 6-6:30pm.</p>
        <p style="margin:0;"><strong>Please be on time as the auditorium is reserved only for the above timings.</strong></p>
      </div>
